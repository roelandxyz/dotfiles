...
-- Go
hi(0, "@function.method.go", { fg = colors.functiondef })
hi(0, "@function.go", { fg = colors.functiondef })
hi(0, "@type.definition.go", { fg = colors.keyword_prominent })
hi(0, "@keyword.type.go", { fg = colors.keyword_noticeable })
hi(0, "@keyword.function.go", { fg = colors.keyword_noticeable })
